...
FROM public."Employee_Information" as employee_information
LEFT JOIN public."Salaries" as salaries ON Employee_Information.Employee_number=Salaries.Employee_number;
...
FROM public."Employee_Information" as employee_information
LEFT JOIN public."Employee_Tenure" as employee_tenure 
